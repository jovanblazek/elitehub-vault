...
export const FactionConflictTypeEnum = pgEnum("factionConflictTypeEnum", enumToPgEnum(FactionConflictType))
...
export const FactionConflictStatusEnum = pgEnum("factionConflictStatusEnum", enumToPgEnum(FactionConflictStatus))
...
export const FactionGovernmentEnum = pgEnum("factionGovernmentEnum", enumToPgEnum(FactionGovernment))
...
export const FactionStates = pgTable("factionStates", {
	...
	activeStates: FactionStateEnum("factionStateEnum")
		.array()
		.default([])
		.notNull(),
	recoveringStates: FactionStateEnum("factionStateEnum")
		.array()
		.default([])
		.notNull(),
	pendingStates: FactionStateEnum("factionStateEnum")
		.array()
		.default([])
		.notNull(),
